...
//	Make a new tree from a list of points.
    public static KDTree MakeFromPoints ( params PVector[] points )
    {
...
//	Simple "median of three" heuristic to find a reasonable splitting plane.
    static int FindSplitPoint ( PVector[] points, int[] inds, int stIndex, int enIndex, int axis )
    {
...
//	Find the nearest point in the set to the supplied point.
    public int FindNearest ( PVector pt )
    {
...
//	Recursively search the tree.
    void SearchNearest ( PVector pt, ref double bestSqSoFar, ref int bestIndex )
    {
    ...
    public int FindSecondNearest ( PVector pt )
    {
        double bestSqDist = 1000000000f;
        int bestIndex = -1;
    ...
    void SearchSecondNearest ( PVector pt, ref double bestSqSoFar, ref int bestIndex, ref int secondBestIndex )
    {
        double mySqDist = ( pivot - pt ).sqrMagnitude;
...
//	Find all points within radius of the supplied point.
    public List<int> FindAllWithinRadius ( PVector pt, double radius )
    {
...
//	Recursively search the tree for points within radius
    void SearchWithinRadius ( PVector pt, ref List<int> indices, double sqrRadius )
    {
        double mySqDist = ( pivot - pt ).sqrMagnitude;
